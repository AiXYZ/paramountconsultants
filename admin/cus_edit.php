...
if(isset($_POST['submit']))
{
	...
	if($image=='')
	{
	 $query="update hap_customer set title='$name',content='$content' where h_id='$id'";
	//echo $query;die;
...
{
$query="update hap_customer set title='$name',image='$image',content='$content' where h_id='$id'";
	$run=mysql_query($query);
	//header("location:categorylist.php");
	echo"<script>window.location='customer_list.php'</script>";
}
