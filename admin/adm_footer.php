...
<section id="main-content">
    ...
    <div class="well well-sm">
        <a href="updatefooter.php" class="btn btn-warning">Update Footer</a>
    </div>
</div>
<?php
if(isset($_POST['submit']))
{
	...
	$query="insert into pages(title,parent,content,image,created_date)values('$title','$parent','$content','$image','$date')";
