...
if(isset($_POST['submit']))
{
	...
	if($image=='')
	{
	 ...
	 $query="update banner set name='$name',content='$content' where b_id='$id'";
	 $run=mysql_query($query) ;
	 echo"<script>window.location='bannerlist.php'</script>";
	 }
	 else{
		  $query="update banner set name='$name',content='$content',image='$image' where b_id='$id'";
		 $run=mysql_query($query) ;
	 echo"<script>window.location='bannerlist.php'</script>";
	 }
...
<section id="main-content">
    ...
    <div class="well well-sm">
        <a href="bannerlist.php" class="btn btn-warning">Back</a>
    </div>
</div>
...
$query="select * from banner where b_id='$id'";
 ...
 ?>
  ...
  <div class="form-group">
    ...
    <textarea rows="4" cols="50" name="content" id="name"><?php echo $row['content'];?></textarea>
