...
if(isset($_POST['submit']))
{
	...
	$content=$_POST['editor'];
	 ...
	 $query="insert into welcome(title,image,content)values('$title','$image','$content')";
	//echo $query;die;
...
<section id="main-content">
    ...
    <div class="well well-sm">
        <a href="wel_content.php" class="btn btn-warning">Welcome Content</a>
    </div>
</div>
...
<div class="well well-sm">
  ...
  <div class="panel-heading"><h3 class="panel-title"><strong>Add Welcome </strong></h3></div>
